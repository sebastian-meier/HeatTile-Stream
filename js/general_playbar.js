...
function setHeatmap(){
	...
	var trequest = "../provider/deliver.php?zoom="+map.getZoom()+"&min_y="+min_y+"&max_y="+max_y+"&min_x="+min_x+"&max_x="+max_x+"&vis="+vis+"&vis_type="+vis_type+"&time=all&ref_id="+(quake_id+1);
